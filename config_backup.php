...
/**
 * Verificar se está logado (simplificado)
 */
function isLoggedIn() {
...
function doLogin($username, $password) {
    ...
    $stmt = $db->prepare("SELECT id, name, email, password FROM usuarios WHERE email = ? OR name = ?");
...
/**
 * Sanitizar entrada (simplificado)
 */
